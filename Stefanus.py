...
def satu(items : pd.core.frame.DataFrame):
    ...
    st.pyplot(Scatter1)
    st.pyplot(Scatter2)
    st.write("<center>Rata-rata berat barang  : 2108.657148732713<br>\
              Rata-rata volume barang : 15273.488057169297<br>\
              Perkiraan harga pengiriman barang : 18.40853503<br>\
              Rata-rata harga pengiriman barang : 20.025485039001275</center>", unsafe_allow_html = True)
